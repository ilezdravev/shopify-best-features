	...
	function(t, e) {
					...
					if (i = n.relative[t[l].type]) d = [xt(St(d), i)];
						...
						if ((i = n.filter[t[l].type].apply(null, t[l].matches))[x]) {
							...
							return Tt(1 < l && St(d), 1 < l && bt(t.slice(0, l - 1).concat({
								value: " " === t[l - 2].type ? "*" : ""
							})).replace(F, "$1"), i, l < o && Ct(t.slice(l, o)), o < r && Ct(t = t.slice(o)), o < r && bt(t))
						}
						d.push(i)
					} return St(d)
			}
		...
		S.extend({
			...
			clone: function(t, e, i) {
				...
				if (e)
					if (i)
						for (r = r || mt(t), s = s || mt(c), n = 0, o = r.length; n < o; n++) Lt(r[n], s[n]);
					else Lt(t, c);
		...
		S.extend(S.event, {
			trigger: function(e, i, n, o) {
				...
				if (s = f = a = n = n || m, 3 !== n.nodeType && 8 !== n.nodeType && !ye.test(y + S.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (e = e[S.expando] ? e : new S.Event(y, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = b.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : S.makeArray(i, [e]), d = S.event.special[y] || {}, o || !d.trigger || !1 !== d.trigger.apply(n, i))) {
					...
					for (r = 0;
						(s = v[r++]) && !e.isPropagationStopped();) f = s, e.type = 1 < r ? l : d.bindType || y, (h = (Y.get(s, "events") || Object.create(null))[e.type] && Y.get(s, "handle")) && h.apply(s, i), (h = u && s[u]) && h.apply && X(s) && (e.result = h.apply(s, i), !1 === e.result && e.preventDefault());
				...
				var n, o, r, s, a, l, u, c, h, d, f = S.ajaxSetup({}, i),
					...
					C = {
						...
						getResponseHeader: function(t) {
							...
							if (u) {
								if (!s)
									for (s = {}; e = ze.exec(r);) s[e[1].toLowerCase() + " "] = (s[e[1].toLowerCase() + " "] || []).concat(e[2]);
								e = s[t.toLowerCase() + " "]
							}
		...
		return w.prototype = Object.assign({}, w.prototype, {
			...
			thumbnailsGoto: function(e) {
				...
				if (this.$carouselNavScroller = t(`[data-thumb__scroller="${this.IdSlider}"]`), this.$carouselNav.find("." + s).removeClass(s), i.addClass(s), this.args.thumbVertical) {
					var o = n.offsetTop;
					S ? this.$carouselNavScroller[0].scrollTop = o - 100 : this.$carouselNavScroller.stop().animate({
						scrollTop: o - 100
					}, 350)
				} else {
					var r = n.offsetLeft;
					S ? this.$carouselNavScroller[0].scrollLeft = r - 100 : this.$carouselNavScroller.stop().animate({
						scrollLeft: r - 100
					}, 350)
				}
			},
