! function(t) {
    ...
    var e = t(window),
        ...
        r = (T4Srequest.page_type, T4Sroutes.search_url, function() {
            window.History;
            var r, o, l, c = t("[data-main-filters-links]"),
            ...
            return v.prototype = Object.assign({}, v.prototype, {
                ...
                setupEventListenersFacets: function() {
                    var e = this;
                    e.$filter = t("#shopify-section-" + e.filter), e.removeDataDelay(), e.$filter.on("click.ntajax", "[data-filter-links] a", function(i) {
                        i.preventDefault(), e.isReloadFilter = !0;
                        const a = t(this);
                        e.ntAjaxStart(), e.$filter.find("[data-drawer-close]").trigger("click.drawer"), e.loadPageContent(a.attr("href")), e.updateURLHash(a, !0)
                    });
                ...
                setupEventListeners: function() {
                    ...
                    i.$container.on("click.ntajax", ".t4s-active-filters a", function(e) {
                        ...
                        e.preventDefault(), i.isReloadFilter = !1;
                        const a = t(this);
                        a.addClass(p), o = `${a.attr("href")}&section_id=${i.main}`, i.isbtnLoadMore = !t(this).is("[data-is-prev]"), i.renderSectionFromFetch(o, i.main, function(t, e) {
                ...
                loadPageContent: function(t) {
                    ...
                    e.renderSection(t, e.main, function(i, a, s, r) {
                        ...
                        e.$container.html(o), e.updateListing(), e.isProduct && T4SThemeSP.reinitProductGridItem(), T4SThemeSP.PopupMFP(), n.trigger("t4s:hideTooltip"), n.trigger("currency:update"), "AjaxIsotope" != e.typeAjax && "LmIsotope" != e.typeAjax || T4SThemeSP.Isotopet4s.init(e.$container.find(".isotopet4s")), e.clickOnScrollButton(), e.$filter && e.$filter.length > 0 && !e.isReloadFilter && e.removeDataDelay(), e.$filter && e.isReloadFilter && e.renderSection(t, e.filter, function(t, i, a, n) {
                            if (n) {
                ...
                layoutSwitching: function(i, a, n) {
                    ...
                    0 != r.length && (s.$section.on("click", "[data-layout-switch] button", function(e) {
                        ...
                        i.parent().find("." + u).removeClass(u), i.addClass(u), "list_t4s" == n ? r.addClass(f + " on--list-" + a) : r.removeClass(f + " on--list-" + a), "mobile" == a ? (r.removeClass("t4s-row-cols-" + o).addClass("t4s-row-cols-" + n), o = n) : "tablet" == a ? (r.removeClass("t4s-row-cols-md-" + l).addClass("t4s-row-cols-md-" + n), l = n) : (r.removeClass("t4s-row-cols-lg-" + c).addClass("t4s-row-cols-lg-" + n), c = n), r.hasClass("isotopet4s") && r.isotopet4s("layout"), lazySizesT4.autoSizer.checkElems(), isStorageSpdLocal && localStorage.setItem("collection_items_per_row_" + a, c), fetch(d + ".js", {
                            body: JSON.stringify({
                ...
                getUrlSortby: function(t) {
                    ...
                    return this.initParams(), this.queryParams.page && delete this.queryParams.page, this.queryParams.sort_by = e, "/" == i.substr(i.length - 1) && (i = i.slice(0, -1)), `${i}/?${unescape(new URLSearchParams(this.queryParams).toString())}`
                },
                getUrlPriceFilter: function(t, e, i, a) {
                    var n = window.location.pathname;
                    return this.initParams(), this.queryParams.page && delete this.queryParams.page, this.queryParams[t] = i, this.queryParams[e] = a, "/" == n.substr(n.length - 1) && (n = n.slice(0, -1)), `${n}/?${unescape(new URLSearchParams(this.queryParams).toString())}`
                },
                onFirstLoadFacets: function() {
                    IsDesignMode && ((e = this).filter = "facets", e.setupEventListenersFacets(), e.filter = "facets_tags", e.setupEventListenersFacets(), i.on("shopify:section:load", function(i) {
                    ...
                    s.length > 0 && (a = "&"), "/" == n.substr(n.length - 1) && (n = n.slice(0, -1)), fetch(`${n}/?${s}${a}section_id=${e.filter}`, {
                        method: "GET",
                        headers: {
                            "Cache-Control": "no-cache"
                        }
                ...
                initLoamoreUpdate: function(t) {
                    t.length > 0 && this.isbtnLoadMore ? this.$section.find("[data-wrap-lm]").html(t.html()) : this.isbtnLoadMore ? this.$section.find("[data-wrap-lm]").hide() : t.length > 0 && !this.isbtnLoadMore ? this.$section.find("[data-wrap-lm-prev]").html(t.html()) : this.isbtnLoadMore || this.$section.find("[data-wrap-lm-prev]").hide(), this.isProduct && T4SThemeSP.reinitProductGridItem(), n.trigger("t4s:hideTooltip"), n.trigger("currency:update"), this.isbtnLoadMore && this.clickOnScrollButton()
                }
            }), v
        }());
